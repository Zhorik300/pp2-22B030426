...
playlist = [
    os.path.abspath("music/Arctic Monkeys - Do I Wanna Know.mp3"),
    os.path.abspath("music/kajjrat-nurtas-njusha-almaty-tunderi.mp3"),
    os.path.abspath("music/music_Lil Uzi Vert - XO TOUR Llif3 (DJ Mustard Remix).mp3")
]
...
class Player:
    ...
    def drawPlayButton(self):
        playButton = pygame.image.load(os.path.abspath("images/playButton.png"))
        playButton = pygame.transform.scale(playButton, (100, 100))
        return playButton

    def drawForwardAndBackwardBtns(self):
        forward = pygame.image.load(os.path.abspath("images/forwardBtn.png"))
        backward = pygame.image.load(os.path.abspath("images/backward.png"))
...
while running:
    ...
    songTitle = font.render(playlist[player.currSong].replace("/Users/diasjakupov/Desktop/python "
                                                              "projects/pp2/lab7/music/", ""), True, (0, 0, 0))
