...
class Brush:
    def __init__(self):
        ...
        self.icon = "brush"
        self.image = pygame.transform.scale(pygame.image.load('p_assets/brush.png'), (100, 100))
    ...
    def update(self):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load(f'p_assets/{self.icon}.png'), (100, 100))
        self.rect = self.image.get_rect()
        self.rect.bottomleft = self.pos
    ...
    def pick_figure_menu(self, surf):
        ...
        for i in Mode.figures:
            img = pygame.transform.scale(pygame.image.load(os.path.abspath(f"p_assets/{i}.png")), (80, 80))
