...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("rassets/coin.png"), (40, 40))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("rassets/Enemy.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("rassets/Player.png")
        self.rect = self.image.get_rect()
...
class Game:
    ...
    def run(self):
        ...
        # road
        background = pygame.image.load("rassets/AnimatedStreet.png")
        ...
        while True:
            ...
            if pygame.sprite.spritecollideany(self.player, self.enemies):
                pygame.mixer.Sound('rassets/crash.wav').play()
                time.sleep(0.5)
